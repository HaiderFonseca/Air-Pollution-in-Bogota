 ...
 */
export function getColorScale(pollutant) {
    const scales = {
        'PM2.5': {
            pollutant: 'PM2.5',
            min: 10,
 ...
 */
export function getColorForConcentration(pollutant, concentration) {
 ...
 */
export function getConcentrationLabel(pollutant, concentration) {
    if (concentration === null || concentration === undefined) {
        return 'Sin dato';
    }
    const scale = getColorScale(pollutant);
